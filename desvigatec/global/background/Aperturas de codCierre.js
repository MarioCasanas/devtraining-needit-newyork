// Código completo para listar las Aperturas de Código de Cierre

try {

    var grcCierre = new GlideRecord('sn_customerservice_mapeio_codigo_de_cierre');
        grcCierre.addEncodedQuery('u_area_tecnica=bdc_bodycam_hytera^u_modalidad_atencion=field_work^u_codigos_cierre=La red');
